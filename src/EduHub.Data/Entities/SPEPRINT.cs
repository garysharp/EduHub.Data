...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class SPEPRINT : EduHubEntity
    {
        ...
        public SPEMAIL CODE_SPEMAIL
        {
            get
            {
                if (Cache_CODE_SPEMAIL == null)
                {
                    Cache_CODE_SPEMAIL = Context.SPEMAIL.FindBySPEMAILKEY(CODE);
                }

                return Cache_CODE_SPEMAIL;
            }
        }
