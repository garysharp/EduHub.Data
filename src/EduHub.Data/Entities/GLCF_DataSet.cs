...
namespace EduHub.Data.Entities
{
    ...
    public sealed class GLCF_DataSet : SetBase<GLCF_Entity>
    {
        internal GLCF_DataSet(EduHubContext Context)
            : base(Context)
        {
            TRREF_Index = new Lazy<Dictionary<string, GLCF_Entity>>(() => this.ToDictionary(e => e.TRREF));
            GST_BOX_Index = new Lazy<Dictionary<string, GLCF_Entity>>(() => this.ToDictionary(e => e.GST_BOX));
