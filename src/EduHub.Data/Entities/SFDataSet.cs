...
BEGIN
    CREATE TABLE [dbo].[SF](
        ...
        [EMERG_NAME01] varchar(50) NULL,
        [EMERG_NAME02] varchar(50) NULL,
        [EMERG_LANG01] varchar(7) NULL,
        [EMERG_LANG02] varchar(7) NULL,
        [EMERG_RELATION01] varchar(30) NULL,
        [EMERG_RELATION02] varchar(30) NULL,
        [EMERG_CONTACT01] varchar(24) NULL,
        [EMERG_CONTACT02] varchar(24) NULL,
