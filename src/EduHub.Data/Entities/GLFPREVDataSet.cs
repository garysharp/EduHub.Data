...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class GLFPREVDataSet : EduHubDataSet<GLFPREV>
    {
            ...
            : base(Context)
        {
            ...
            Index_FEE_CODE = new Lazy<NullDictionary<string, IReadOnlyList<GLFPREV>>>(() => this.ToGroupedNullDictionary(i => i.FEE_CODE));
        ...
        internal override Action<GLFPREV, string>[] BuildMapper(IReadOnlyList<string> Headers)
        {
        ...
        /// </summary>
        /// <param name="Entities">Iterator for base <see cref="GLFPREV" /> entities</param>
        /// <param name="DeltaEntities">List of delta <see cref="GLFPREV" /> entities</param>
        /// <returns>A merged <see cref="IEnumerable{GLFPREV}"/> of entities</returns>
        internal override IEnumerable<GLFPREV> ApplyDeltaEntities(IEnumerable<GLFPREV> Entities, List<GLFPREV> DeltaEntities)
        {
        ...
        private Lazy<NullDictionary<string, IReadOnlyList<GLFPREV>>> Index_FEE_CODE;
        ...
        /// <summary>
        /// Find GLFPREV by FEE_CODE field
        /// </summary>
        /// <param name="FEE_CODE">FEE_CODE value used to find GLFPREV</param>
        /// <returns>List of related GLFPREV entities</returns>
        /// <exception cref="ArgumentOutOfRangeException">No match was found</exception>
        public IReadOnlyList<GLFPREV> FindByFEE_CODE(string FEE_CODE)
        {
            return Index_FEE_CODE.Value[FEE_CODE];
        }

        /// <summary>
        /// Attempt to find GLFPREV by FEE_CODE field
        /// </summary>
        /// <param name="FEE_CODE">FEE_CODE value used to find GLFPREV</param>
        /// <param name="Value">List of related GLFPREV entities</param>
        /// <returns>True if the list of related GLFPREV entities is found</returns>
        /// <exception cref="ArgumentOutOfRangeException">No match was found</exception>
        public bool TryFindByFEE_CODE(string FEE_CODE, out IReadOnlyList<GLFPREV> Value)
        {
        ...
        /// <returns>List of related GLFPREV entities, or null if not found</returns>
        /// <exception cref="ArgumentOutOfRangeException">No match was found</exception>
        public IReadOnlyList<GLFPREV> TryFindByFEE_CODE(string FEE_CODE)
        {
            IReadOnlyList<GLFPREV> value;
        ...
        /// <summary>
        /// Returns a <see cref="SqlCommand"/> which checks for the existence of a GLFPREV table, and if not found, creates the table and associated indexes.
        /// </summary>
        ...
        public override SqlCommand GetSqlCreateTableCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GLFPREV]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
    ...
    CREATE NONCLUSTERED INDEX [GLFPREV_Index_FEE_CODE] ON [dbo].[GLFPREV]
    (
            [FEE_CODE] ASC
    );
...
");
        ...
        /// <summary>
        /// Returns a <see cref="SqlCommand"/> which deletes the <see cref="GLFPREV"/> entities passed
        /// </summary>
        /// <param name="SqlConnection">The <see cref="SqlConnection"/> to be associated with the <see cref="SqlCommand"/></param>
        /// <param name="Entities">The <see cref="GLFPREV"/> entities to be deleted</param>
        public override SqlCommand GetSqlDeleteCommand(SqlConnection SqlConnection, IEnumerable<GLFPREV> Entities)
        {
            ...
            builder.AppendLine("DELETE [dbo].[GLFPREV] WHERE");
        ...
        public override EduHubDataSetDataReader<GLFPREV> GetDataSetDataReader()
        {
            return new GLFPREVDataReader(Load());
        }
        ...
        /// </summary>
        /// <returns>A <see cref="IDataReader"/> for the GLFPREV data set</returns>
        public override EduHubDataSetDataReader<GLFPREV> GetDataSetDataReader(List<GLFPREV> Entities)
        {
            return new GLFPREVDataReader(new EduHubDataSetLoadedReader<GLFPREV>(this, Entities));
        }

        // Modest implementation to primarily support SqlBulkCopy
        private class GLFPREVDataReader : EduHubDataSetDataReader<GLFPREV>
        {
            public GLFPREVDataReader(IEduHubDataSetReader<GLFPREV> Reader)
                : base (Reader)
            {
            }
