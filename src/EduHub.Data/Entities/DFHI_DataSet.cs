...
namespace EduHub.Data.Entities
{
    ...
    /// </summary>
    public sealed class DFHI_DataSet : SetBase<DFHI_Entity>
    {
        internal DFHI_DataSet(EduHubContext Context)
            : base(Context)
        {
        }

        public override string SetName { get { return "DFHI"; } }


        
        protected override Action<DFHI_Entity, string>[] BuildMapper(List<string> Headers)
        {
            var mapper = new Action<DFHI_Entity, string>[Headers.Count];
