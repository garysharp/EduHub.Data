...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class FER_FDT : EduHubEntity
    {

        #region Navigation Property Cache

        private SKGS Cache_SOURCE_SKGS;
        ...
        public SKGS SOURCE_SKGS
        {
            get
            {
                if (Cache_SOURCE_SKGS == null)
                {
                    Cache_SOURCE_SKGS = Context.SKGS.FindBySCHOOL(SOURCE);
                }

                return Cache_SOURCE_SKGS;
            }
        }
