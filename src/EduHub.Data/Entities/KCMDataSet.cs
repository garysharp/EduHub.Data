...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[KCM]') AND name = N'KCM_Index_LW_DATE')
    ALTER INDEX [KCM_Index_LW_DATE] ON [dbo].[KCM] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[KCM]') AND name = N'KCM_Index_LW_DATE')
    ALTER INDEX [KCM_Index_LW_DATE] ON [dbo].[KCM] REBUILD PARTITION = ALL;
");
        }
