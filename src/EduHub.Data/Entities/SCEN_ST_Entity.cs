...
namespace EduHub.Data.Entities
{
    ...
    /// Census Student Data
    /// </summary>
    public class SCEN_ST_Entity : EntityBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Student Key of the student on the day that the Census process is run. [Uppercase Alphanumeric: u10]
        /// </summary>
        public string STKEY { get; internal set; }
        /// <summary>
        /// Automatically generated number [Integer (32bit signed nullable): l]
        /// </summary>
        public int? REGISTRATION { get; internal set; }
        /// <summary>
        /// Surname of the student [Uppercase Alphanumeric: u30]
        /// </summary>
