            ...
            for (var i = 0; i < Headers.Count; i++) {
                switch (Headers[i]) {
                    ...
                    case "SUBPROGRAM":
                        ...
                        break;
                    case "COMMENCEMENT":
                        mapper[i] = (e, v) => e.COMMENCEMENT = v == null ? (DateTime?)null : DateTime.ParseExact(v, "d/MM/yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
                        break;
                    case "COMPLETION":
                        mapper[i] = (e, v) => e.COMPLETION = v == null ? (DateTime?)null : DateTime.ParseExact(v, "d/MM/yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
                        break;
                    case "PROJECT_COST":
