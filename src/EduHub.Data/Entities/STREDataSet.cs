            ...
            for (var i = 0; i < Headers.Count; i++) {
                switch (Headers[i]) {
                    ...
                    case "SKEY":
                        ...
                        break;
                    case "ST_ENTRY":
                        mapper[i] = (e, v) => e.ST_ENTRY = v == null ? (DateTime?)null : DateTime.ParseExact(v, "d/MM/yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
                        break;
                    case "ST_EXIT_DATE":
                        mapper[i] = (e, v) => e.ST_EXIT_DATE = v == null ? (DateTime?)null : DateTime.ParseExact(v, "d/MM/yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
                        break;
                    case "ST_SCHOOL_YEAR":
                    ...
                    case "ST_NEXT_SCHOOL":
                        ...
                        break;
                    case "ST_VISA_EXPIRY":
                        mapper[i] = (e, v) => e.ST_VISA_EXPIRY = v == null ? (DateTime?)null : DateTime.ParseExact(v, "d/MM/yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
                        break;
...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_DF_LOTE_HOME_CODE_A')
    ALTER INDEX [STRE_Index_DF_LOTE_HOME_CODE_A] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_DF_LOTE_HOME_CODE_B')
    ALTER INDEX [STRE_Index_DF_LOTE_HOME_CODE_B] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_CAMPUS')
    ALTER INDEX [STRE_Index_ST_CAMPUS] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_HOME_GROUP')
    ALTER INDEX [STRE_Index_ST_HOME_GROUP] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_HOME_LANG')
    ALTER INDEX [STRE_Index_ST_HOME_LANG] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_LOTE_HOME_CODE')
    ALTER INDEX [STRE_Index_ST_LOTE_HOME_CODE] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_NEXT_SCHOOL')
    ALTER INDEX [STRE_Index_ST_NEXT_SCHOOL] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_PREVIOUS_SCHOOL')
    ALTER INDEX [STRE_Index_ST_PREVIOUS_SCHOOL] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_SCHOOL_YEAR')
    ALTER INDEX [STRE_Index_ST_SCHOOL_YEAR] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_VISA_SUBCLASS')
    ALTER INDEX [STRE_Index_ST_VISA_SUBCLASS] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM01')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM01] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM02')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM02] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM03')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM03] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM04')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM04] ON [dbo].[STRE] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_TID')
    ALTER INDEX [STRE_Index_TID] ON [dbo].[STRE] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_DF_LOTE_HOME_CODE_A')
    ALTER INDEX [STRE_Index_DF_LOTE_HOME_CODE_A] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_DF_LOTE_HOME_CODE_B')
    ALTER INDEX [STRE_Index_DF_LOTE_HOME_CODE_B] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_CAMPUS')
    ALTER INDEX [STRE_Index_ST_CAMPUS] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_HOME_GROUP')
    ALTER INDEX [STRE_Index_ST_HOME_GROUP] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_HOME_LANG')
    ALTER INDEX [STRE_Index_ST_HOME_LANG] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_LOTE_HOME_CODE')
    ALTER INDEX [STRE_Index_ST_LOTE_HOME_CODE] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_NEXT_SCHOOL')
    ALTER INDEX [STRE_Index_ST_NEXT_SCHOOL] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_PREVIOUS_SCHOOL')
    ALTER INDEX [STRE_Index_ST_PREVIOUS_SCHOOL] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_SCHOOL_YEAR')
    ALTER INDEX [STRE_Index_ST_SCHOOL_YEAR] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_ST_VISA_SUBCLASS')
    ALTER INDEX [STRE_Index_ST_VISA_SUBCLASS] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM01')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM01] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM02')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM02] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM03')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM03] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_STPT_SCHL_NUM04')
    ALTER INDEX [STRE_Index_STPT_SCHL_NUM04] ON [dbo].[STRE] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STRE]') AND name = N'STRE_Index_TID')
    ALTER INDEX [STRE_Index_TID] ON [dbo].[STRE] REBUILD PARTITION = ALL;
");
        }
