...
namespace EduHub.Data.Entities
{
    ...
    /// </summary>
    public sealed class ST_TFR_DataSet : SetBase<ST_TFR_Entity>
    {

        internal ST_TFR_DataSet(EduHubContext Context)
            : base(Context)
        {
        }
        ...
        /// Data Set Name
        /// </summary>
        public override string SetName { get { return "ST_TFR"; } }

        protected override Action<ST_TFR_Entity, string>[] BuildMapper(List<string> Headers)
        {
            var mapper = new Action<ST_TFR_Entity, string>[Headers.Count];
