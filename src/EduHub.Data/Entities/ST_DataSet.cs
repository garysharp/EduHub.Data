...
namespace EduHub.Data.Entities
{
    ...
    public sealed class ST_DataSet : SetBase<ST_Entity>
    {
        ...
        internal ST_DataSet(EduHubContext Context)
            : base(Context)
        {
            STKEY_Index = new Lazy<Dictionary<string, ST_Entity>>(() => this.ToDictionary(e => e.STKEY));
            REGISTRATION_Index = new Lazy<Dictionary<int, ST_Entity>>(() => this.ToDictionary(e => e.REGISTRATION));
        ...
        {
            ST_Entity result;
            if (STKEY_Index.Value.TryGetValue(Key, out result))
            {
                return result;
            }
            else
        ...
        {
            ST_Entity result;
            if (REGISTRATION_Index.Value.TryGetValue(Key, out result))
            {
                return result;
            }
            else
        ...
        {
            ST_Entity result;
            if (TAG_Index.Value.TryGetValue(Key, out result))
            {
                return result;
            }
            else
