...
namespace EduHub.Data.Entities
{
    ...
    /// </summary>
    public sealed class SCEN_ASTDataSet : SetBase<SCEN_AST>
    {
        private Lazy<Dictionary<int, SCEN_AST>> IDIndex;

        internal SCEN_ASTDataSet(EduHubContext Context)
            : base(Context)
        {
            IDIndex = new Lazy<Dictionary<int, SCEN_AST>>(() => this.ToDictionary(e => e.ID));
        }
        ...
        public SCEN_AST FindByID(int Key)
        {
            SCEN_AST result;
        ...
        public bool TryFindByID(int Key, out SCEN_AST Value)
        {
        ...
        public SCEN_AST TryFindByID(int Key)
        {
            SCEN_AST result;
            if (IDIndex.Value.TryGetValue(Key, out result))
            {
        ...
        protected override Action<SCEN_AST, string>[] BuildMapper(List<string> Headers)
        {
