...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_CAMPUS')
    ALTER INDEX [STVDO_Index_CAMPUS] ON [dbo].[STVDO] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_LW_DATE')
    ALTER INDEX [STVDO_Index_LW_DATE] ON [dbo].[STVDO] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_ORIGINAL_SCHOOL')
    ALTER INDEX [STVDO_Index_ORIGINAL_SCHOOL] ON [dbo].[STVDO] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_SKEY_VDIMENSION_YEAR_SEMESTER_VDOMAIN_SCORE')
    ALTER INDEX [STVDO_Index_SKEY_VDIMENSION_YEAR_SEMESTER_VDOMAIN_SCORE] ON [dbo].[STVDO] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_TID')
    ALTER INDEX [STVDO_Index_TID] ON [dbo].[STVDO] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_VDIMENSION')
    ALTER INDEX [STVDO_Index_VDIMENSION] ON [dbo].[STVDO] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_VDOMAIN')
    ALTER INDEX [STVDO_Index_VDOMAIN] ON [dbo].[STVDO] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_CAMPUS')
    ALTER INDEX [STVDO_Index_CAMPUS] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_LW_DATE')
    ALTER INDEX [STVDO_Index_LW_DATE] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_ORIGINAL_SCHOOL')
    ALTER INDEX [STVDO_Index_ORIGINAL_SCHOOL] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_SKEY_VDIMENSION_YEAR_SEMESTER_VDOMAIN_SCORE')
    ALTER INDEX [STVDO_Index_SKEY_VDIMENSION_YEAR_SEMESTER_VDOMAIN_SCORE] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_TID')
    ALTER INDEX [STVDO_Index_TID] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_VDIMENSION')
    ALTER INDEX [STVDO_Index_VDIMENSION] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO]') AND name = N'STVDO_Index_VDOMAIN')
    ALTER INDEX [STVDO_Index_VDOMAIN] ON [dbo].[STVDO] REBUILD PARTITION = ALL;
");
        }
