...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class STSP : EduHubEntity
    {
        ...
        private ST Cache_SPKEY_ST;
        private SF Cache_REF_TEACHERA_SF;
        private SF Cache_REF_TEACHERB_SF;
        ...
        public ST SPKEY_ST
        {
            get
            {
                if (Cache_SPKEY_ST == null)
                {
                    Cache_SPKEY_ST = Context.ST.FindBySTKEY(SPKEY);
                }

                return Cache_SPKEY_ST;
            }
        }
        ...
        public SF REF_TEACHERA_SF
        {
            get
            {
                ...
                if (Cache_REF_TEACHERA_SF == null)
                {
                    Cache_REF_TEACHERA_SF = Context.SF.FindBySFKEY(REF_TEACHERA);
                }

                return Cache_REF_TEACHERA_SF;
            }
        }
        ...
        public SF REF_TEACHERB_SF
        {
            get
            {
                ...
                if (Cache_REF_TEACHERB_SF == null)
                {
                    Cache_REF_TEACHERB_SF = Context.SF.FindBySFKEY(REF_TEACHERB);
                }

                return Cache_REF_TEACHERB_SF;
            }
        }
