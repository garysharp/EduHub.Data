...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class GLCFPREVDataSet : DataSetBase<GLCFPREV>
    {
        /// <summary>
        /// Data Set Name
        /// </summary>
        ...
        /// <summary>
        /// Returns SQL which checks for the existence of a GLCFPREV table, and if not found, creates the table and associated indexes.
        /// </summary>
        protected override string GetCreateTableSql()
        {
            return @"IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GLCFPREV]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
...
END";
        ...
        {
            return new GLCFPREVDataReader(Items.Value);
        }

        // Modest implementation to primarily support SqlBulkCopy
        private class GLCFPREVDataReader : IDataReader, IDataRecord
        {
            private List<GLCFPREV> Items;
            private int CurrentIndex;
            private GLCFPREV CurrentItem;

            public GLCFPREVDataReader(List<GLCFPREV> Items)
            {
                this.Items = Items;
