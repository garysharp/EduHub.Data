...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SCSFAG]') AND name = N'SCSFAG_Index_SCSFKEY_YEAR_SEMESTER_ST_CAMPUS_ST_YEAR_LEVEL_ST_CATEGORY')
    ALTER INDEX [SCSFAG_Index_SCSFKEY_YEAR_SEMESTER_ST_CAMPUS_ST_YEAR_LEVEL_ST_CATEGORY] ON [dbo].[SCSFAG] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SCSFAG]') AND name = N'SCSFAG_Index_ST_YEAR_LEVEL')
    ALTER INDEX [SCSFAG_Index_ST_YEAR_LEVEL] ON [dbo].[SCSFAG] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SCSFAG]') AND name = N'SCSFAG_Index_TID')
    ALTER INDEX [SCSFAG_Index_TID] ON [dbo].[SCSFAG] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SCSFAG]') AND name = N'SCSFAG_Index_SCSFKEY_YEAR_SEMESTER_ST_CAMPUS_ST_YEAR_LEVEL_ST_CATEGORY')
    ALTER INDEX [SCSFAG_Index_SCSFKEY_YEAR_SEMESTER_ST_CAMPUS_ST_YEAR_LEVEL_ST_CATEGORY] ON [dbo].[SCSFAG] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SCSFAG]') AND name = N'SCSFAG_Index_ST_YEAR_LEVEL')
    ALTER INDEX [SCSFAG_Index_ST_YEAR_LEVEL] ON [dbo].[SCSFAG] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SCSFAG]') AND name = N'SCSFAG_Index_TID')
    ALTER INDEX [SCSFAG_Index_TID] ON [dbo].[SCSFAG] REBUILD PARTITION = ALL;
");
        }
