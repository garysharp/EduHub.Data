...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO_TR]') AND name = N'STVDO_TR_Index_STVDO_TRANS_ID')
    ALTER INDEX [STVDO_TR_Index_STVDO_TRANS_ID] ON [dbo].[STVDO_TR] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO_TR]') AND name = N'STVDO_TR_Index_TID')
    ALTER INDEX [STVDO_TR_Index_TID] ON [dbo].[STVDO_TR] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO_TR]') AND name = N'STVDO_TR_Index_STVDO_TRANS_ID')
    ALTER INDEX [STVDO_TR_Index_STVDO_TRANS_ID] ON [dbo].[STVDO_TR] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STVDO_TR]') AND name = N'STVDO_TR_Index_TID')
    ALTER INDEX [STVDO_TR_Index_TID] ON [dbo].[STVDO_TR] REBUILD PARTITION = ALL;
");
        }
