...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class SCEN_STDataSet : EduHubDataSet<SCEN_ST>
    {
        /// <inheritdoc />
        ...
        internal override Action<SCEN_ST, string>[] BuildMapper(IReadOnlyList<string> Headers)
        {
        ...
        /// </summary>
        /// <param name="Entities">Iterator for base <see cref="SCEN_ST" /> entities</param>
        /// <param name="DeltaEntities">List of delta <see cref="SCEN_ST" /> entities</param>
        /// <returns>A merged <see cref="IEnumerable{SCEN_ST}"/> of entities</returns>
        internal override IEnumerable<SCEN_ST> ApplyDeltaEntities(IEnumerable<SCEN_ST> Entities, List<SCEN_ST> DeltaEntities)
        {
        ...
        /// <summary>
        /// Returns a <see cref="SqlCommand"/> which checks for the existence of a SCEN_ST table, and if not found, creates the table and associated indexes.
        /// </summary>
        ...
        public override SqlCommand GetSqlCreateTableCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[SCEN_ST]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
...
END");
        ...
        /// <summary>
        /// Returns null as <see cref="SCEN_STDataSet"/> has no non-clustered indexes.
        /// </summary>
        /// <param name="SqlConnection">The <see cref="SqlConnection"/> to be associated with the <see cref="SqlCommand"/></param>
        ...
        /// <summary>
        /// Returns a <see cref="SqlCommand"/> which deletes the <see cref="SCEN_ST"/> entities passed
        /// </summary>
        /// <param name="SqlConnection">The <see cref="SqlConnection"/> to be associated with the <see cref="SqlCommand"/></param>
        /// <param name="Entities">The <see cref="SCEN_ST"/> entities to be deleted</param>
        public override SqlCommand GetSqlDeleteCommand(SqlConnection SqlConnection, IEnumerable<SCEN_ST> Entities)
        {
            ...
            builder.AppendLine("DELETE [dbo].[SCEN_ST] WHERE");
        ...
        public override EduHubDataSetDataReader<SCEN_ST> GetDataSetDataReader()
        {
            return new SCEN_STDataReader(Load());
        }
        ...
        /// </summary>
        /// <returns>A <see cref="IDataReader"/> for the SCEN_ST data set</returns>
        public override EduHubDataSetDataReader<SCEN_ST> GetDataSetDataReader(List<SCEN_ST> Entities)
        {
            return new SCEN_STDataReader(new EduHubDataSetLoadedReader<SCEN_ST>(this, Entities));
        }

        // Modest implementation to primarily support SqlBulkCopy
        private class SCEN_STDataReader : EduHubDataSetDataReader<SCEN_ST>
        {
            public SCEN_STDataReader(IEduHubDataSetReader<SCEN_ST> Reader)
                : base (Reader)
            {
            }
