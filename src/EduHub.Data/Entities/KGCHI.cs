...
namespace EduHub.Data.Entities
{
    ...
    public sealed partial class KGCHI : EduHubEntity
    {

        #region Navigation Property Cache

        private KGC Cache_KGCKEY_KGC;
        ...
        public KGC KGCKEY_KGC
        {
            get
            {
                ...
                if (Cache_KGCKEY_KGC == null)
                {
                    Cache_KGCKEY_KGC = Context.KGC.FindByKGCKEY(KGCKEY);
                }

                return Cache_KGCKEY_KGC;
            }
        }
