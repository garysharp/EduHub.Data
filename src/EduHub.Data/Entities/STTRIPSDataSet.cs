...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_PICKUP_ADDRESS_ID')
    ALTER INDEX [STTRIPS_Index_AM_PICKUP_ADDRESS_ID] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_ROUTE_ID')
    ALTER INDEX [STTRIPS_Index_AM_ROUTE_ID] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_SETDOWN_CAMPUS')
    ALTER INDEX [STTRIPS_Index_AM_SETDOWN_CAMPUS] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_TRANSPORT_MODE')
    ALTER INDEX [STTRIPS_Index_AM_TRANSPORT_MODE] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_PICKUP_CAMPUS')
    ALTER INDEX [STTRIPS_Index_PM_PICKUP_CAMPUS] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_ROUTE_ID')
    ALTER INDEX [STTRIPS_Index_PM_ROUTE_ID] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_SETDOWN_ADDRESS_ID')
    ALTER INDEX [STTRIPS_Index_PM_SETDOWN_ADDRESS_ID] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_TRANSPORT_MODE')
    ALTER INDEX [STTRIPS_Index_PM_TRANSPORT_MODE] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_STUDENT_ID_TRAVEL_DAY')
    ALTER INDEX [STTRIPS_Index_STUDENT_ID_TRAVEL_DAY] ON [dbo].[STTRIPS] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_TID')
    ALTER INDEX [STTRIPS_Index_TID] ON [dbo].[STTRIPS] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_PICKUP_ADDRESS_ID')
    ALTER INDEX [STTRIPS_Index_AM_PICKUP_ADDRESS_ID] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_ROUTE_ID')
    ALTER INDEX [STTRIPS_Index_AM_ROUTE_ID] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_SETDOWN_CAMPUS')
    ALTER INDEX [STTRIPS_Index_AM_SETDOWN_CAMPUS] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_AM_TRANSPORT_MODE')
    ALTER INDEX [STTRIPS_Index_AM_TRANSPORT_MODE] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_PICKUP_CAMPUS')
    ALTER INDEX [STTRIPS_Index_PM_PICKUP_CAMPUS] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_ROUTE_ID')
    ALTER INDEX [STTRIPS_Index_PM_ROUTE_ID] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_SETDOWN_ADDRESS_ID')
    ALTER INDEX [STTRIPS_Index_PM_SETDOWN_ADDRESS_ID] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_PM_TRANSPORT_MODE')
    ALTER INDEX [STTRIPS_Index_PM_TRANSPORT_MODE] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_STUDENT_ID_TRAVEL_DAY')
    ALTER INDEX [STTRIPS_Index_STUDENT_ID_TRAVEL_DAY] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STTRIPS]') AND name = N'STTRIPS_Index_TID')
    ALTER INDEX [STTRIPS_Index_TID] ON [dbo].[STTRIPS] REBUILD PARTITION = ALL;
");
        }
