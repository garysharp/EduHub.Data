...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_AM_TYPE')
    ALTER INDEX [SXABCONV_Index_AM_TYPE] ON [dbo].[SXABCONV] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_LW_DATE')
    ALTER INDEX [SXABCONV_Index_LW_DATE] ON [dbo].[SXABCONV] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_PM_TYPE')
    ALTER INDEX [SXABCONV_Index_PM_TYPE] ON [dbo].[SXABCONV] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_ST_YEAR_LEVEL')
    ALTER INDEX [SXABCONV_Index_ST_YEAR_LEVEL] ON [dbo].[SXABCONV] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_STKEY')
    ALTER INDEX [SXABCONV_Index_STKEY] ON [dbo].[SXABCONV] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_STKEY_ABSENCE_DATE')
    ALTER INDEX [SXABCONV_Index_STKEY_ABSENCE_DATE] ON [dbo].[SXABCONV] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_AM_TYPE')
    ALTER INDEX [SXABCONV_Index_AM_TYPE] ON [dbo].[SXABCONV] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_LW_DATE')
    ALTER INDEX [SXABCONV_Index_LW_DATE] ON [dbo].[SXABCONV] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_PM_TYPE')
    ALTER INDEX [SXABCONV_Index_PM_TYPE] ON [dbo].[SXABCONV] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_ST_YEAR_LEVEL')
    ALTER INDEX [SXABCONV_Index_ST_YEAR_LEVEL] ON [dbo].[SXABCONV] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_STKEY')
    ALTER INDEX [SXABCONV_Index_STKEY] ON [dbo].[SXABCONV] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SXABCONV]') AND name = N'SXABCONV_Index_STKEY_ABSENCE_DATE')
    ALTER INDEX [SXABCONV_Index_STKEY_ABSENCE_DATE] ON [dbo].[SXABCONV] REBUILD PARTITION = ALL;
");
        }
