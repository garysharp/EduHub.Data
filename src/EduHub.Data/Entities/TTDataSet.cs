...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_CAMPUS')
    ALTER INDEX [TT_Index_CAMPUS] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR01')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR01] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR02')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR02] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR03')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR03] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR04')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR04] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR05')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR05] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR06')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR06] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR07')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR07] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR08')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR08] ON [dbo].[TT] DISABLE;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR09')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR09] ON [dbo].[TT] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_CAMPUS')
    ALTER INDEX [TT_Index_CAMPUS] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR01')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR01] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR02')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR02] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR03')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR03] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR04')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR04] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR05')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR05] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR06')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR06] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR07')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR07] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR08')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR08] ON [dbo].[TT] REBUILD PARTITION = ALL;
IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[TT]') AND name = N'TT_Index_SUBJECT_ACADEMIC_YEAR09')
    ALTER INDEX [TT_Index_SUBJECT_ACADEMIC_YEAR09] ON [dbo].[TT] REBUILD PARTITION = ALL;
");
        }
