...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SKGS]') AND name = N'SKGS_Index_LW_DATE')
    ALTER INDEX [SKGS_Index_LW_DATE] ON [dbo].[SKGS] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[SKGS]') AND name = N'SKGS_Index_LW_DATE')
    ALTER INDEX [SKGS_Index_LW_DATE] ON [dbo].[SKGS] REBUILD PARTITION = ALL;
");
        }
